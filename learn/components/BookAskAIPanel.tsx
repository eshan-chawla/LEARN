                            ...
                            <div key={`${message.id}-step-${step.id}-${index}`} className="rounded-xl bg-white/80 px-3 py-2">
                              <div className="flex items-start justify-between gap-3">
                                <div className="flex min-w-0 gap-2">
                                  <span className="mt-0.5 inline-flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-stone-100 text-[10px] font-semibold tabular-nums text-stone-500">
                                    {index + 1}
                                  </span>
                                  <div className="min-w-0">
